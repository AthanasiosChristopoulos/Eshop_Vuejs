    <template>
      ...
      <div v-if="getAll" class="allProducts">
        <div v-for="data in get_data" class="products">
          <div class="delete_button" @click="delete_product(data.id)"><i class="bi bi-trash"></i></div>
          <div class="update_button" @click="update_modal(data.id)"><i class="bi bi-pencil"></i></div>
